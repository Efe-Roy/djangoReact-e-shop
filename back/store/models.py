...
class Item(models.Model):
    ...
    # category = models.ForeignKey(Category, related_name='items', on_delete=models.CASCADE) #ManyToManyField
...
class ItemVariation(models.Model):
    ...
    attachment = models.ImageField(upload_to="static/img/products", blank=True, null= True)
